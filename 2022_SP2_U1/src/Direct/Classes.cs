...
namespace TS3D.Exchange.Direct
{
    ...
    public class A3DFRMFeatureTreeWrapper : IDisposable
    {
    ...
    public class A3DFRMFeatureTypeWrapper : IDisposable
    {
    ...
    public class A3DFRMFeatureLinkedItemWrapper : IDisposable
    {
    ...
    public class A3DFRMFeatureGeomEntitiesWrapper : IDisposable
    {
