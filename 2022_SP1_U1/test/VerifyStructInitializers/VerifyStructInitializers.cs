...
namespace TS3D.Exchange.Test {
    class Program {
        ...
        [DllImport("build/VerifyInitializers.test")]
        private static extern Int32 Verify_A3DFRMFeatureTreeData(IntPtr d);
        [DllImport("build/VerifyInitializers.test")]
        private static extern Int32 Verify_A3DFRMParameterData(IntPtr d);
        [DllImport("build/VerifyInitializers.test")]
        private static extern Int32 Verify_A3DFRMFeatureTypeData(IntPtr d);
        [DllImport("build/VerifyInitializers.test")]
        ...
        [DllImport("build/VerifyInitializers.test")]
        private static extern Int32 Verify_A3DFRMFeatureLinkedItemData(IntPtr d);
        [DllImport("build/VerifyInitializers.test")]
        private static extern Int32 Verify_A3DFRMFeatureData(IntPtr d);
        [DllImport("build/VerifyInitializers.test")]
        private static extern Int32 Verify_A3DFRMFeatureGeomEntitiesData(IntPtr d);
        [DllImport("build/VerifyInitializers.test")]
        ...
        static void Main( string[] args) {
            ...
            }
            {
                ...
                IntPtr ptr = Marshal.AllocHGlobal(Marshal.SizeOf(d));
                Marshal.StructureToPtr(d, ptr, false);
                if(0 != Verify_A3DFRMFeatureTreeData(ptr)) {
                    Console.WriteLine( "FAILURE: A3DFRMFeatureTreeData" );
                }
                Marshal.FreeHGlobal(ptr);
            }
            {
            ...
            }
            {
                ...
                IntPtr ptr = Marshal.AllocHGlobal(Marshal.SizeOf(d));
                Marshal.StructureToPtr(d, ptr, false);
                if(0 != Verify_A3DFRMFeatureTypeData(ptr)) {
                    Console.WriteLine( "FAILURE: A3DFRMFeatureTypeData" );
                }
                Marshal.FreeHGlobal(ptr);
            }
            {
            ...
            }
            {
                ...
                IntPtr ptr = Marshal.AllocHGlobal(Marshal.SizeOf(d));
                Marshal.StructureToPtr(d, ptr, false);
                if(0 != Verify_A3DFRMFeatureLinkedItemData(ptr)) {
                    Console.WriteLine( "FAILURE: A3DFRMFeatureLinkedItemData" );
                }
                Marshal.FreeHGlobal(ptr);
            }
            {
            ...
            }
            {
                ...
                IntPtr ptr = Marshal.AllocHGlobal(Marshal.SizeOf(d));
                Marshal.StructureToPtr(d, ptr, false);
                if(0 != Verify_A3DFRMFeatureGeomEntitiesData(ptr)) {
                    Console.WriteLine( "FAILURE: A3DFRMFeatureGeomEntitiesData" );
                }
                Marshal.FreeHGlobal(ptr);
            }
            {
