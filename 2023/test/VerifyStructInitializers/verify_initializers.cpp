...
extern "C" {
    ...
    DECL_SPEC int32_t Verify_A3DFRMTreeData(A3DFRMTreeData *from_csharp) {
        A3DFRMTreeData d;
        A3D_INITIALIZE_DATA( A3DFRMTreeData, d );
        return memcmp( &d, from_csharp, sizeof(A3DFRMTreeData));
    }
    ...
    DECL_SPEC int32_t Verify_A3DFRMTypeData(A3DFRMTypeData *from_csharp) {
        A3DFRMTypeData d;
        A3D_INITIALIZE_DATA( A3DFRMTypeData, d );
        return memcmp( &d, from_csharp, sizeof(A3DFRMTypeData));
    }
    ...
    DECL_SPEC int32_t Verify_A3DFRMLinkedItemData(A3DFRMLinkedItemData *from_csharp) {
        A3DFRMLinkedItemData d;
        A3D_INITIALIZE_DATA( A3DFRMLinkedItemData, d );
        return memcmp( &d, from_csharp, sizeof(A3DFRMLinkedItemData));
    }
    ...
    DECL_SPEC int32_t Verify_A3DFRMGeomEntitiesData(A3DFRMGeomEntitiesData *from_csharp) {
        A3DFRMGeomEntitiesData d;
        A3D_INITIALIZE_DATA( A3DFRMGeomEntitiesData, d );
        return memcmp( &d, from_csharp, sizeof(A3DFRMGeomEntitiesData));
    }
