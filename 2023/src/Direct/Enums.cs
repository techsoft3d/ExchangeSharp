namespace TS3D.Exchange.Direct
{
    public enum A3DEEntityType
    {
        ...
        kA3DTypeMiscConstraintLinkedItem = 210,
        ...
        kA3DTypeMDFCFDraftingIndicator = 10148,
        ...
        kA3DTypeBIMData = 3001,
        kA3DTypeBIMRoot = 3002,
        kA3DTypeBIMObjectDefinition = 3010,
        kA3DTypeBIMRelationship = 3100,
        kA3DTypeBIMProject = 3011,
        kA3DTypeBIMObject = 3020,
        kA3DTypeBIMProduct = 3021,
        kA3DTypeBIMSpatialStructureElement = 3022,
        kA3DTypeBIMBuilding = 3023,
        kA3DTypeBIMBuildingStorey = 3024,
        kA3DTypeBIMSpace = 3025,
        kA3DTypeBIMSite = 3026,
        kA3DTypeBIMElement = 3041,
        kA3DTypeBIMBuildingElement = 3042,
        kA3DTypeBIMBFeatureElement = 3091,
        kA3DTypeBIMRelDecomposes = 3101,
        kA3DTypeBIMRelConnects = 3120,
        kA3DTypeBIMRelContainedInSpatialStructure = 3121,
        kA3DTypeBIMRelAggregates = 3122,
        kA3DTypeBIMRelFillsElement = 3123,
        kA3DTypeBIMRelVoidsElement = 3124,
        kA3DTypeBIMRelSpaceBoundary = 3125,
        kA3DTypeBIMRelConnectsPathElements = 3126,
        kA3DTypeBIMChimney = 3043,
        kA3DTypeBIMColumn = 3044,
        kA3DTypeBIMCovering = 3045,
        kA3DTypeBIMCurtainWall = 3046,
        kA3DTypeBIMDoor = 3047,
        kA3DTypeBIMFooting = 3048,
        kA3DTypeBIMMember = 3049,
        kA3DTypeBIMPile = 3050,
        kA3DTypeBIMPlate = 3051,
        kA3DTypeBIMRailing = 3052,
        kA3DTypeBIMRamp = 3053,
        kA3DTypeBIMRampFlight = 3054,
        kA3DTypeBIMRoof = 3055,
        kA3DTypeBIMShadingDevice = 3056,
        kA3DTypeBIMSlab = 3057,
        kA3DTypeBIMStair = 3058,
        kA3DTypeBIMStairFlight = 3059,
        kA3DTypeBIMWall = 3060,
        kA3DTypeBIMWindow = 3061,
        kA3DTypeBIMObjectPlacement = 3069,
        kA3DTypeFeatureElementSubtraction = 3092,
        kA3DTypeFeatureElementAddition = 3093,
        kA3DTypeBIMOpeningElement = 3094,
        kA3DTypeBIMVoidingFeature = 3095,
        kA3DTypeBIMOpeningStandardCase = 3096
}
    ...
    public enum A3DETextureMappingOperator
    {
        ...
        kA3DTextureMappingOperatorSurfacic = 5,
        kA3DTextureMappingOperatorSurfacic02 = 6,
        kA3DTextureMappingOperatorCubical02 = 7,
        kA3DTextureMappingOperatorCylindrical02 = 8,
        kA3DTextureMappingOperatorSpherical02 = 9,
        kA3DTextureMappingOperatorLabel = 10
}
    ...
    public enum A3DEUnits
    {
        ...
        kA3DUnitKilometer = 8,
        kA3DUnitMile = 9,
        kA3DUnitMicroInch = 10,
        kA3DUnitMil = 11,
        kA3DUnitAngstrom = 12,
        kA3DUnitNanometer = 13,
        kA3DUnitMicron = 14,
        kA3DUnitDecimeter = 15,
        kA3DUnitDekameter = 16,
        kA3DUnitHectometer = 17,
        kA3DUnitGigameter = 18,
        kA3DUnitAstronomical = 19,
        kA3DUnitLightYear = 20,
        kA3DUnitParsec = 21,
        kA3DUnitUSSurveyFoot = 22,
        kA3DUnitUSSurveyInch = 23,
        kA3DUnitUSSurveyYard = 24,
        kA3DUnitUSSurveyMile = 25,
        kA3DUnitUnknown = 26
}
    ...
    public enum EA3DLeaderAlignmentType
    {
    ...
    public enum EA3DFCFIndicatorSymbol
    {
        ...
        kA3DFCFIndicatorSymbol_Runout = 5
}
    ...
    public enum EA3DRevitMultiThreadedMode
    {
        kA3DRevitMultiThreadedMode_Disabled = 0,
        kA3DRevitMultiThreadedMode_LoadingEnabled = 1,
        kA3DRevitMultiThreadedMode_RegenerationEnabled = 2,
        kA3DRevitMultiThreadedMode_LoadingAndRegenerationEnabled = 3
}
    ...
    public enum EA3DConstraintLinkType
    {
        kA3DConstraintLink_None = 0,
        kA3DConstraintLink_Axis = 1,
        kA3DConstraintLink_Center = 2
}

    public enum EA3DConstraintType
    {
        kA3DConstraintType_None = 0,
        kA3DConstraintType_Set = 1,
        kA3DConstraintType_Fix = 2,
        kA3DConstraintType_FixTogether = 3,
        kA3DConstraintType_Contact = 4,
        kA3DConstraintType_Distance = 5,
        kA3DConstraintType_Angle = 6,
        kA3DConstraintType_Perpendicular = 7,
        kA3DConstraintType_Parallel = 8
}

    public enum EA3DContactType
    {
        kA3DContactType_None = 0,
        kA3DContactType_Unknown = 1,
        kA3DContactType_Surface = 2,
        kA3DContactType_Annular = 3,
        kA3DContactType_Line = 4,
        kA3DContactType_Point = 5
}

    public enum EA3DConstraintStatus
    {
        kA3DConstraintStatus_OK = 0,
        kA3DConstraintStatus_Disabled = 1,
        kA3DConstraintStatus_Error = 2
}
    ...
    public enum EA3DFRMDefinitionThreadType
    {
        kA3DFRMDefinitionThreadType_None = 0,
        kA3DFRMDefinitionThreadType_Undercut = 1,
        kA3DFRMDefinitionThreadType_Shaft = 2
}
    ...
    public enum EA3DFRMFamily
    {
        ...
        kA3DFamily_Definition_Thread = 12
}
