...
{
    public class A3DVector2dWrapper : IDisposable
    {
    ...
    public class A3DVector3dWrapper : IDisposable
    {
    ...
    public class A3DIntervalWrapper : IDisposable
    {
    ...
    public class A3DDomainWrapper : IDisposable
    {
    ...
    public class A3DBoundingBoxWrapper : IDisposable
    {
    ...
    public class A3DParameterizationWrapper : IDisposable
    {
    ...
    public class A3DUVParameterizationWrapper : IDisposable
    {
    ...
    public class A3DTessBaseWrapper : IDisposable
    {
    ...
    public class A3DTessFaceWrapper : IDisposable
    {
    ...
    public class A3DTess3DWrapper : IDisposable
    {
    ...
    public class A3DTess3DWireWrapper : IDisposable
    {
    ...
    public class A3DTessMarkupWrapper : IDisposable
    {
    ...
    public class A3DGraphicsWrapper : IDisposable
    {
    ...
    public class A3DGraphStyleWrapper : IDisposable
    {
    ...
    public class A3DGraphRgbColorWrapper : IDisposable
    {
    ...
    public class A3DGraphLinePatternWrapper : IDisposable
    {
    ...
    public class A3DGraphMaterialWrapper : IDisposable
    {
    ...
    public class A3DGraphPictureWrapper : IDisposable
    {
    ...
    public class A3DGraphDottingPatternWrapper : IDisposable
    {
    ...
    public class A3DGraphHatchingPatternLineWrapper : IDisposable
    {
    ...
    public class A3DGraphHatchingPatternWrapper : IDisposable
    {
    ...
    public class A3DGraphSolidPatternWrapper : IDisposable
    {
    ...
    public class A3DGraphVPicturePatternWrapper : IDisposable
    {
    ...
    public class A3DGraphCameraWrapper : IDisposable
    {
    ...
    public class A3DGraphAmbientLightWrapper : IDisposable
    {
    ...
    public class A3DGraphPointLightWrapper : IDisposable
    {
    ...
    public class A3DGraphSpotLightWrapper : IDisposable
    {
    ...
    public class A3DGraphDirectionalLightWrapper : IDisposable
    {
    ...
    public class A3DGraphSceneDisplayParametersWrapper : IDisposable
    {
    ...
    public class A3DMiscCascadedAttributesWrapper : IDisposable
    {
    ...
    public class A3DMiscGeneralTransformationWrapper : IDisposable
    {
    ...
    public class A3DMiscCartesianTransformationWrapper : IDisposable
    {
    ...
    public class A3DMiscEntityReferenceWrapper : IDisposable
    {
    ...
    public class A3DMiscReferenceOnTopologyWrapper : IDisposable
    {
    ...
    public class A3DMiscReferenceOnTessWrapper : IDisposable
    {
    ...
    public class A3DMiscReferenceOnCsysItemWrapper : IDisposable
    {
    ...
    public class A3DMiscPhysicMaterialWrapper : IDisposable
    {
    ...
    public class A3DMiscMaterialFiberWrapper : IDisposable
    {
    ...
    public class A3DMiscMaterialHoneyCombWrapper : IDisposable
    {
    ...
    public class A3DMiscMaterialIsotropicWrapper : IDisposable
    {
    ...
    public class A3DMiscMaterialOrthotropic2DWrapper : IDisposable
    {
    ...
    public class A3DMiscMaterialOrthotropic3DWrapper : IDisposable
    {
    ...
    public class A3DMiscMaterialAnisotropicWrapper : IDisposable
    {
    ...
    public class A3DMiscMaterialPropertiesWrapper : IDisposable
    {
    ...
    public class A3DAsmModelFileWrapper : IDisposable
    {
        ...
        public IntPtr m_pBIMData=>_d.m_pBIMData;

        private A3DAsmModelFileData _d;
    }
    public class A3DAsmProductOccurrenceWrapper : IDisposable
    {
        ...
        public uint m_uiContraintsSize=>_d.m_uiContraintsSize;
        public IntPtr m_ppConstraints=>_d.m_ppConstraints;

        private A3DAsmProductOccurrenceData _d;
    }
    public class A3DAsmProductOccurrenceDataSLWWrapper : IDisposable
    {
    ...
    public class A3DAsmProductOccurrenceDataCatWrapper : IDisposable
    {
    ...
    public class A3DAsmProductOccurrenceDataCV5Wrapper : IDisposable
    {
    ...
    public class A3DAsmProductOccurrenceDataUgWrapper : IDisposable
    {
    ...
    public class A3DAsmProductOccurrenceDataProeWrapper : IDisposable
    {
    ...
    public class A3DAsmProductOccurrenceDataInvWrapper : IDisposable
    {
    ...
    public class A3DAsmProductOccurrenceDataJTWrapper : IDisposable
    {
    ...
    public class A3DAsmPartDefinitionWrapper : IDisposable
    {
    ...
    public class A3DAsmLayerFilterItemWrapper : IDisposable
    {
    ...
    public class A3DAsmEntityFilterItemWrapper : IDisposable
    {
    ...
    public class A3DAsmFilterWrapper : IDisposable
    {
    ...
    public class A3DRWParamsGeneralWrapper : IDisposable
    {
        ...
        public bool m_bReadConstraints => _d.m_bReadConstraints;
    ...
    public class A3DRWParamsPmiWrapper : IDisposable
    {
    ...
    public class A3DRWParamsTessellationWrapper : IDisposable
    {
    ...
    public class A3DRWParamsSearchDirWrapper : IDisposable
    {
    ...
    public class A3DRWParamsAssemblyWrapper : IDisposable
    {
    ...
    public class A3DRWParamsMultiEntriesWrapper : IDisposable
    {
    ...
    public class A3DRWParamsCatiaV4Wrapper : IDisposable
    {
    ...
    public class A3DRWParamsCatiaV5Wrapper : IDisposable
    {
    ...
    public class A3DRWParamsUnigraphicsWrapper : IDisposable
    {
    ...
    public class A3DRWParamsProEWrapper : IDisposable
    {
    ...
    public class A3DRWValidationPropertiesThresholdWrapper : IDisposable
    {
    ...
    public class A3DRWParamsStepWrapper : IDisposable
    {
    ...
    public class A3DRWParamsIGESWrapper : IDisposable
    {
    ...
    public class A3DRWParamsIFCWrapper : IDisposable
    {
        ...
        public bool m_bReadRelationships => _d.m_bReadRelationships;
        public bool m_bReadOpeningElements => _d.m_bReadOpeningElements;

        private A3DRWParamsIFCData _d;
    }
    public class A3DRWParamsJTWrapper : IDisposable
    {
    ...
    public class A3DRWParamsParasolidWrapper : IDisposable
    {
    ...
    public class A3DRWParamsSolidworksWrapper : IDisposable
    {
    ...
    public class A3DRWParamsInventorWrapper : IDisposable
    {
    ...
    public class A3DRWParamsRhinoWrapper : IDisposable
    {
    ...
    public class A3DRWParamsRevitWrapper : IDisposable
    {
        ...
        public EA3DRevitMultiThreadedMode m_eMultiThreadedMode=>_d.m_eMultiThreadedMode;
        public uint m_uiLinkFlags=>_d.m_uiLinkFlags;

        private A3DRWParamsRevitData _d;
    }
    public class A3DRWParamsSpecificLoadWrapper : IDisposable
    {
    ...
    public class A3DRWParamsIncrementalLoadWrapper : IDisposable
    {
    ...
    public class A3DRWParamsLoadWrapper : IDisposable
    {
    ...
    public class A3DStream3DPDFWrapper : IDisposable
    {
    ...
    public class A3DRWParamsExportPrcWrapper : IDisposable
    {
    ...
    public class A3DRWParamsExportU3DWrapper : IDisposable
    {
    ...
    public class A3DRWParamsExportStepWrapper : IDisposable
    {
    ...
    public class A3DRWParamsExportJTWrapper : IDisposable
    {
    ...
    public class A3DRWParamsExportIgesWrapper : IDisposable
    {
    ...
    public class A3DRWParamsExportStlWrapper : IDisposable
    {
    ...
    public class A3DRWParamsExport3mfWrapper : IDisposable
    {
    ...
    public class A3DRWParamsExportXMLWrapper : IDisposable
    {
    ...
    public class A3DRWParamsExportObjWrapper : IDisposable
    {
    ...
    public class A3DRWParamsExportFbxWrapper : IDisposable
    {
    ...
    public class A3DRWParamsExportGltfWrapper : IDisposable
    {
        public A3DRWParamsExportGltfWrapper()
        {
            API.Initialize(out _d);
        }
        ...
        private A3DRWParamsExportGltfData _d;
    }
    public class A3DSewOptionsWrapper : IDisposable
    {
    ...
    public class A3DFaceUVPointInsideManagerWrapper : IDisposable
    {
    ...
    public class A3DProjectedPointCloudWrapper : IDisposable
    {
    ...
    public class A3DProjectPointCloudManagerDataFromRIWrapper : IDisposable
    {
    ...
    public class A3DProjectPointCloudOptionsWrapper : IDisposable
    {
        public A3DProjectPointCloudOptionsWrapper()
        {
            API.Initialize(out _d);
        }
        ...
        public ushort m_usStructSize=>_d.m_usStructSize;
        public bool m_bUseExactComputation => _d.m_bUseExactComputation;
        public uint m_uNbThreads=>_d.m_uNbThreads;
        public double m_dInsidePointEdgeTolerance=>_d.m_dInsidePointEdgeTolerance;
        public bool m_bUseProbe => _d.m_bUseProbe;
        public double m_dProbeRadius=>_d.m_dProbeRadius;
        public bool m_bPreferFaceTowardScan => _d.m_bPreferFaceTowardScan;
        public double m_dTolForPreferFaceTowardScan=>_d.m_dTolForPreferFaceTowardScan;

        private A3DProjectPointCloudOptionsData _d;
    }
    public class A3DPlanarSectionWrapper : IDisposable
    {
    ...
    public class A3DCompareInputWrapper : IDisposable
    {
    ...
    public class A3DCompareOutputWrapper : IDisposable
    {
    ...
    public class A3DMultiPlanarSectionWrapper : IDisposable
    {
    ...
    public class A3DHLRViewPlaneWrapper : IDisposable
    {
    ...
    public class A3DHLRCurveWrapper : IDisposable
    {
    ...
    public class A3DHLRSectionFaceWrapper : IDisposable
    {
    ...
    public class A3DHLRRepresentationItemWrapper : IDisposable
    {
    ...
    public class A3DHLROptionsWrapper : IDisposable
    {
    ...
    public class A3DTransfoRepresentationItemWrapper : IDisposable
    {
    ...
    public class A3DCollisionGroupWrapper : IDisposable
    {
    ...
    public class A3DCollisionParameterWrapper : IDisposable
    {
    ...
    public class A3DCollisionResultWrapper : IDisposable
    {
    ...
    public class A3DBIMDataWrapper : IDisposable
    {
        public A3DBIMDataWrapper()
        {
            API.Initialize(out _d);
        }

        public A3DBIMDataWrapper(IntPtr p)
        {
            API.Initialize(out _d);
            if( p != IntPtr.Zero )
            {
                API.A3DBIMDataGet( p, ref _d );
            }
        }

        public void Dispose()
        {
            API.A3DBIMDataGet( IntPtr.Zero, ref _d );
        }
        public ushort m_usStructSize=>_d.m_usStructSize;
        public uint m_uiRelationshipSize=>_d.m_uiRelationshipSize;
        public IntPtr m_ppRelationships=>_d.m_ppRelationships;
        public IntPtr m_PProject=>_d.m_PProject;

        private A3DBIMDataData _d;
    }
    public class A3DBIMRelContainedInSpatialStructureWrapper : IDisposable
    {
        public A3DBIMRelContainedInSpatialStructureWrapper()
        {
            API.Initialize(out _d);
        }

        public A3DBIMRelContainedInSpatialStructureWrapper(IntPtr p)
        {
            API.Initialize(out _d);
            if( p != IntPtr.Zero )
            {
                API.A3DBIMRelContainedInSpatialStructureGet( p, ref _d );
            }
        }

        public void Dispose()
        {
            API.A3DBIMRelContainedInSpatialStructureGet( IntPtr.Zero, ref _d );
        }
        public ushort m_usStructSize=>_d.m_usStructSize;
        public uint m_uiRelatedElementSize=>_d.m_uiRelatedElementSize;
        public IntPtr m_ppRelatedElements=>_d.m_ppRelatedElements;
        public IntPtr m_pRelating=>_d.m_pRelating;

        private A3DBIMRelContainedInSpatialStructureData _d;
    }
    public class A3DBIMRelFillsElementWrapper : IDisposable
    {
        public A3DBIMRelFillsElementWrapper()
        {
            API.Initialize(out _d);
        }

        public A3DBIMRelFillsElementWrapper(IntPtr p)
        {
            API.Initialize(out _d);
            if( p != IntPtr.Zero )
            {
                API.A3DBIMRelFillsElementGet( p, ref _d );
            }
        }

        public void Dispose()
        {
            API.A3DBIMRelFillsElementGet( IntPtr.Zero, ref _d );
        }
        public ushort m_usStructSize=>_d.m_usStructSize;
        public uint m_uiRelatedElementSize=>_d.m_uiRelatedElementSize;
        public IntPtr m_ppRelatedElements=>_d.m_ppRelatedElements;
        ...
        private A3DBIMRelFillsElementData _d;
    }
    public class A3DBIMRelSpaceBoundaryWrapper : IDisposable
    {
        public A3DBIMRelSpaceBoundaryWrapper()
        {
            API.Initialize(out _d);
        }

        public A3DBIMRelSpaceBoundaryWrapper(IntPtr p)
        {
            API.Initialize(out _d);
            if( p != IntPtr.Zero )
            {
                API.A3DBIMRelSpaceBoundaryGet( p, ref _d );
            }
        }

        public void Dispose()
        {
            API.A3DBIMRelSpaceBoundaryGet( IntPtr.Zero, ref _d );
        }
        public ushort m_usStructSize=>_d.m_usStructSize;
        public uint m_uiRelatedElementSize=>_d.m_uiRelatedElementSize;
        public IntPtr m_ppRelatedElements=>_d.m_ppRelatedElements;
        ...
        private A3DBIMRelSpaceBoundaryData _d;
    }
    public class A3DBIMRelAggregatesWrapper : IDisposable
    {
        public A3DBIMRelAggregatesWrapper()
        {
            API.Initialize(out _d);
        }

        public A3DBIMRelAggregatesWrapper(IntPtr p)
        {
            API.Initialize(out _d);
            if( p != IntPtr.Zero )
            {
                API.A3DBIMRelAggregatesGet( p, ref _d );
            }
        }

        public void Dispose()
        {
            API.A3DBIMRelAggregatesGet( IntPtr.Zero, ref _d );
        }
        public ushort m_usStructSize=>_d.m_usStructSize;
        public uint m_uiRelatedElementSize=>_d.m_uiRelatedElementSize;
        public IntPtr m_ppRelatedElements=>_d.m_ppRelatedElements;
        ...
        private A3DBIMRelAggregatesData _d;
    }
    public class A3DBIMRelVoidsElementWrapper : IDisposable
    {
        public A3DBIMRelVoidsElementWrapper()
        {
            API.Initialize(out _d);
        }

        public A3DBIMRelVoidsElementWrapper(IntPtr p)
        {
            API.Initialize(out _d);
            if( p != IntPtr.Zero )
            {
                API.A3DBIMRelVoidsElementGet( p, ref _d );
            }
        }

        public void Dispose()
        {
            API.A3DBIMRelVoidsElementGet( IntPtr.Zero, ref _d );
        }
        public ushort m_usStructSize=>_d.m_usStructSize;
        public uint m_uiRelatedElementSize=>_d.m_uiRelatedElementSize;
        public IntPtr m_ppRelatedElements=>_d.m_ppRelatedElements;
        ...
        private A3DBIMRelVoidsElementData _d;
    }
    public class A3DBIMRelConnectsPathElementsWrapper : IDisposable
    {
        public A3DBIMRelConnectsPathElementsWrapper()
        {
            API.Initialize(out _d);
        }

        public A3DBIMRelConnectsPathElementsWrapper(IntPtr p)
        {
            API.Initialize(out _d);
            if( p != IntPtr.Zero )
            {
                API.A3DBIMRelConnectsPathElementsGet( p, ref _d );
            }
        }

        public void Dispose()
        {
            API.A3DBIMRelConnectsPathElementsGet( IntPtr.Zero, ref _d );
        }
        public ushort m_usStructSize=>_d.m_usStructSize;
        public IntPtr m_pRelating=>_d.m_pRelating;
        public uint m_uiRelatedElementSize=>_d.m_uiRelatedElementSize;
        ...
        private A3DBIMRelConnectsPathElementsData _d;
    }
    public class A3DBIMRootWrapper : IDisposable
    {
        public A3DBIMRootWrapper()
        {
            API.Initialize(out _d);
        }

        public A3DBIMRootWrapper(IntPtr p)
        {
            API.Initialize(out _d);
            if( p != IntPtr.Zero )
            {
                API.A3DBIMRootGet( p, ref _d );
            }
        }

        public void Dispose()
        {
            API.A3DBIMRootGet( IntPtr.Zero, ref _d );
        }
        public ushort m_usStructSize=>_d.m_usStructSize;
        public string m_pcGUID => _d.m_pcGUID;
        public string m_pcName => _d.m_pcName;
        public string m_pcDescription => _d.m_pcDescription;
        public string m_pcIfcClassName => _d.m_pcIfcClassName;
        public IntPtr m_pEntityReference=>_d.m_pEntityReference;

        private A3DBIMRootData _d;
    }
    public class A3DMiscConstraintLinkedItemWrapper : IDisposable
    {
        public A3DMiscConstraintLinkedItemWrapper()
        {
            API.Initialize(out _d);
        }

        public A3DMiscConstraintLinkedItemWrapper(IntPtr p)
        {
            API.Initialize(out _d);
            if( p != IntPtr.Zero )
            {
                API.A3DMiscConstraintLinkedItemGet( p, ref _d );
            }
        }

        public void Dispose()
        {
            API.A3DMiscConstraintLinkedItemGet( IntPtr.Zero, ref _d );
        }
        public ushort m_usStructSize=>_d.m_usStructSize;
        public EA3DConstraintLinkType m_eType=>_d.m_eType;
        public IntPtr m_pTargetProductOccurrence=>_d.m_pTargetProductOccurrence;
        public IntPtr m_pReference=>_d.m_pReference;

        private A3DMiscConstraintLinkedItemData _d;
    }
    public class A3DAsmConstraintWrapper : IDisposable
    {
        public A3DAsmConstraintWrapper()
        {
            API.Initialize(out _d);
        }

        public A3DAsmConstraintWrapper(IntPtr p)
        {
            API.Initialize(out _d);
            if( p != IntPtr.Zero )
            {
                API.A3DAsmConstraintGet( p, ref _d );
            }
        }

        public void Dispose()
        {
            API.A3DAsmConstraintGet( IntPtr.Zero, ref _d );
        }
        public ushort m_usStructSize=>_d.m_usStructSize;
        public EA3DConstraintType m_eType=>_d.m_eType;
        public EA3DConstraintStatus m_eStatus=>_d.m_eStatus;
        public uint m_uiSubConstraintsSize=>_d.m_uiSubConstraintsSize;
        public IntPtr m_ppSubConstraints=>_d.m_ppSubConstraints;
        public uint m_uiConstrainedElementsSize=>_d.m_uiConstrainedElementsSize;
        public IntPtr m_ppConstrainedElements=>_d.m_ppConstrainedElements;
        public uint m_uiAdditionalDataArraySize=>_d.m_uiAdditionalDataArraySize;
        public IntPtr m_pAdditionalDataArray=>_d.m_pAdditionalDataArray;

        private A3DAsmConstraintData _d;
    }
    public class A3DMkpLeaderWrapper : IDisposable
    {
    ...
    public class A3DMkpAnnotationItemWrapper : IDisposable
    {
    ...
    public class A3DMkpAnnotationSetWrapper : IDisposable
    {
    ...
    public class A3DMkpAnnotationReferenceWrapper : IDisposable
    {
    ...
    public class A3DMkpViewWrapper : IDisposable
    {
    ...
    public class A3DMkpViewFlagsWrapper : IDisposable
    {
    ...
    public class A3DMiscMarkupLinkedItemWrapper : IDisposable
    {
    ...
    public class A3DMkpMarkupWrapper : IDisposable
    {
    ...
    public class A3DMkpRTFFieldWrapper : IDisposable
    {
    ...
    public class A3DFontKeyWrapper : IDisposable
    {
    ...
    public class A3DFontWrapper : IDisposable
    {
    ...
    public class A3DGraphTextureTransformationWrapper : IDisposable
    {
    ...
    public class A3DGraphTextureDefinitionWrapper : IDisposable
    {
    ...
    public class A3DGraphTextureApplicationWrapper : IDisposable
    {
    ...
    public class A3DDrawingModelWrapper : IDisposable
    {
    ...
    public class A3DDrawingSheetFormatWrapper : IDisposable
    {
    ...
    public class A3DDrawingSheetWrapper : IDisposable
    {
    ...
    public class A3DDrawingClipFrameWrapper : IDisposable
    {
    ...
    public class A3DDrawingViewWrapper : IDisposable
    {
    ...
    public class A3DDrawingBlockBasicWrapper : IDisposable
    {
    ...
    public class A3DDrawingBlockOperatorWrapper : IDisposable
    {
    ...
    public class A3DDrawingCurveWrapper : IDisposable
    {
    ...
    public class A3DDrawingFilledAreaWrapper : IDisposable
    {
    ...
    public class A3DDrawingPictureWrapper : IDisposable
    {
    ...
    public class A3DDrawingVerticesWrapper : IDisposable
    {
    ...
    public class A3DThumbnailWrapper : IDisposable
    {
    ...
    public class A3DFileInformationWrapper : IDisposable
    {
    ...
    public class A3DFileContextWrapper : IDisposable
    {
    ...
    public class A3DRWParamsExportParasolidWrapper : IDisposable
    {
        ...
        public bool m_bBinary => _d.m_bBinary;

        private A3DRWParamsExportParasolidData _d;
    }
    public class A3DRWParamsTranslateToPkPartsWrapper : IDisposable
    {
    ...
    public class A3DRWParamsExportAcisWrapper : IDisposable
    {
    ...
    public class A3DRiRepresentationItemWrapper : IDisposable
    {
    ...
    public class A3DRiSetWrapper : IDisposable
    {
    ...
    public class A3DRiPointSetWrapper : IDisposable
    {
    ...
    public class A3DRiDirectionWrapper : IDisposable
    {
    ...
    public class A3DRiCoordinateSystemWrapper : IDisposable
    {
    ...
    public class A3DRiCurveWrapper : IDisposable
    {
    ...
    public class A3DRiPlaneWrapper : IDisposable
    {
    ...
    public class A3DRiBrepModelWrapper : IDisposable
    {
    ...
    public class A3DRiPolyBrepModelWrapper : IDisposable
    {
    ...
    public class A3DRiPolyWireWrapper : IDisposable
    {
    ...
    public class A3DFRMTreeWrapper : IDisposable
    {
        public A3DFRMTreeWrapper()
        {
            API.Initialize(out _d);
        }

        public A3DFRMTreeWrapper(IntPtr p)
        {
            API.Initialize(out _d);
            if( p != IntPtr.Zero )
            {
                API.A3DFRMTreeGet( p, ref _d );
            }
        }

        public void Dispose()
        {
            API.A3DFRMTreeGet( IntPtr.Zero, ref _d );
        }
        public ushort m_usStructSize=>_d.m_usStructSize;
        ...
        private A3DFRMTreeData _d;
    }
    public class A3DFRMParameterWrapper : IDisposable
    {
    ...
    public class A3DFRMTypeWrapper : IDisposable
    {
        public A3DFRMTypeWrapper()
        {
            API.Initialize(out _d);
        }
        ...
        private A3DFRMTypeData _d;
    }
    public class A3DFRMStringWrapper : IDisposable
    {
    ...
    public class A3DFRMDoubleWrapper : IDisposable
    {
    ...
    public class A3DFRMIntegerWrapper : IDisposable
    {
    ...
    public class A3DFRMLinkedItemWrapper : IDisposable
    {
        public A3DFRMLinkedItemWrapper()
        {
            API.Initialize(out _d);
        }

        public A3DFRMLinkedItemWrapper(IntPtr p)
        {
            API.Initialize(out _d);
            if( p != IntPtr.Zero )
            {
                API.A3DFRMLinkedItemGet( p, ref _d );
            }
        }

        public void Dispose()
        {
            API.A3DFRMLinkedItemGet( IntPtr.Zero, ref _d );
        }
        public ushort m_usStructSize=>_d.m_usStructSize;
        ...
        private A3DFRMLinkedItemData _d;
    }
    public class A3DFRMFeatureWrapper : IDisposable
    {
        ...
        public ushort m_usStructSize=>_d.m_usStructSize;
        public A3DFRMTypeData m_sType=>_d.m_sType;
        public uint m_uiParametersSize=>_d.m_uiParametersSize;
    ...
    public class A3DFRMGeomEntitiesWrapper : IDisposable
    {
        public A3DFRMGeomEntitiesWrapper()
        {
            API.Initialize(out _d);
        }
        ...
        private A3DFRMGeomEntitiesData _d;
    }
    public class A3DCrvNurbsWrapper : IDisposable
    {
    ...
    public class A3DCrvLineWrapper : IDisposable
    {
    ...
    public class A3DCrvCircleWrapper : IDisposable
    {
    ...
    public class A3DCrvEllipseWrapper : IDisposable
    {
    ...
    public class A3DCrvParabolaWrapper : IDisposable
    {
    ...
    public class A3DCrvHyperbolaWrapper : IDisposable
    {
    ...
    public class A3DCrvPolyLineWrapper : IDisposable
    {
    ...
    public class A3DCrvCompositeWrapper : IDisposable
    {
    ...
    public class A3DCrvEquationWrapper : IDisposable
    {
    ...
    public class A3DCrvTransformWrapper : IDisposable
    {
    ...
    public class A3DCrvOnSurfWrapper : IDisposable
    {
    ...
    public class A3DCrvOffsetWrapper : IDisposable
    {
    ...
    public class A3DCrvHelixPitchCstWrapper : IDisposable
    {
    ...
    public class A3DCrvHelixPitchVarWrapper : IDisposable
    {
    ...
    public class A3DCrvHelixWrapper : IDisposable
    {
    ...
    public class A3DCrossingPointsCrvIntersectionWrapper : IDisposable
    {
    ...
    public class A3DCrvIntersectionWrapper : IDisposable
    {
    ...
    public class A3DCrvBlend02BoundaryWrapper : IDisposable
    {
    ...
    public class A3DSurfNurbsWrapper : IDisposable
    {
    ...
    public class A3DSurfSphereWrapper : IDisposable
    {
    ...
    public class A3DSurfCylinderWrapper : IDisposable
    {
    ...
    public class A3DSurfTorusWrapper : IDisposable
    {
    ...
    public class A3DSurfRevolutionWrapper : IDisposable
    {
    ...
    public class A3DSurfExtrusionWrapper : IDisposable
    {
    ...
    public class A3DSurfOffsetWrapper : IDisposable
    {
    ...
    public class A3DSurfPlaneWrapper : IDisposable
    {
    ...
    public class A3DSurfBlend01Wrapper : IDisposable
    {
    ...
    public class A3DSurfBlend02Wrapper : IDisposable
    {
    ...
    public class A3DSurfBlend03Wrapper : IDisposable
    {
    ...
    public class A3DSurfConeWrapper : IDisposable
    {
    ...
    public class A3DSurfCylindricalWrapper : IDisposable
    {
    ...
    public class A3DSurfRuledWrapper : IDisposable
    {
    ...
    public class A3DSurfPipeWrapper : IDisposable
    {
    ...
    public class A3DSurfTransformWrapper : IDisposable
    {
    ...
    public class A3DSurfFromCurvesWrapper : IDisposable
    {
    ...
    public class A3DGlobalWrapper : IDisposable
    {
    ...
    public class A3DMDPosition3DWrapper : IDisposable
    {
    ...
    public class A3DMDPosition2DWrapper : IDisposable
    {
    ...
    public class A3DMDPositionReferenceWrapper : IDisposable
    {
    ...
    public class A3DMDLeaderSymbolWrapper : IDisposable
    {
    ...
    public class A3DMDMarkupLeaderStubWrapper : IDisposable
    {
    ...
    public class A3DMDLeaderDefinitionWrapper : IDisposable
    {
    ...
    public class A3DMDTextPropertiesWrapper : IDisposable
    {
    ...
    public class A3DMarkupDefinitionWrapper : IDisposable
    {
    ...
    public class A3DMDDimensionValueFormatWrapper : IDisposable
    {
    ...
    public class A3DMDDimensionSimpleToleranceFormatWrapper : IDisposable
    {
    ...
    public class A3DMDDimensionCombinedToleranceFormatWrapper : IDisposable
    {
    ...
    public class A3DMDDimensionValueWrapper : IDisposable
    {
    ...
    public class A3DMDDimensionSecondPartWrapper : IDisposable
    {
    ...
    public class A3DMDDimensionForeshortenedWrapper : IDisposable
    {
    ...
    public class A3DMDDimensionLineSymbolWrapper : IDisposable
    {
    ...
    public class A3DMDDimensionLineWrapper : IDisposable
    {
    ...
    public class A3DMDDimensionFunnelWrapper : IDisposable
    {
    ...
    public class A3DMDDimensionExtremityWrapper : IDisposable
    {
    ...
    public class A3DMDDimensionExtentionLineWrapper : IDisposable
    {
    ...
    public class A3DMarkupDimensionWrapper : IDisposable
    {
    ...
    public class A3DMarkupRoughnessWrapper : IDisposable
    {
    ...
    public class A3DMarkupBalloonWrapper : IDisposable
    {
    ...
    public class A3DMarkupFastenerWrapper : IDisposable
    {
    ...
    public class A3DMarkupLocatorWrapper : IDisposable
    {
    ...
    public class A3DMarkupMeasurementPointWrapper : IDisposable
    {
    ...
    public class A3DMDTextPositionWrapper : IDisposable
    {
    ...
    public class A3DMarkupTextWrapper : IDisposable
    {
        ...
        public EA3DLeaderAlignmentType m_eLeaderAlignmentType=>_d.m_eLeaderAlignmentType;
        public IntPtr m_pTextProperties=>_d.m_pTextProperties;
        public IntPtr m_psTextPosition=>_d.m_psTextPosition;

        private A3DMarkupTextData _d;
    }
    public class A3DMarkupCoordinateWrapper : IDisposable
    {
    ...
    public class A3DMarkupRichTextWrapper : IDisposable
    {
    ...
    public class A3DMarkupDatumWrapper : IDisposable
    {
    ...
    public class A3DMDFCFDraftingRowWrapper : IDisposable
    {
    ...
    public class A3DMDFCValueWrapper : IDisposable
    {
    ...
    public class A3DMDFCTolerancePerUnitWrapper : IDisposable
    {
    ...
    public class A3DMDFCProjectedZoneWrapper : IDisposable
    {
    ...
    public class A3DMDFCFToleranceValueWrapper : IDisposable
    {
    ...
    public class A3DMDFCFRowDatumWrapper : IDisposable
    {
    ...
    public class A3DMDFCFDrawingRowWrapper : IDisposable
    {
    ...
    public class A3DMDFCFIndicatorWrapper : IDisposable
    {
        ...
        public string m_pcText => _d.m_pcText;
        public uint m_uiNumberOfLinkedItems=>_d.m_uiNumberOfLinkedItems;
        public IntPtr m_ppLinkedItems=>_d.m_ppLinkedItems;

        private A3DMDFCFIndicatorData _d;
    }
    public class A3DMDFCFDraftingIndicatorWrapper : IDisposable
    {
        public A3DMDFCFDraftingIndicatorWrapper()
        {
            API.Initialize(out _d);
        }

        public A3DMDFCFDraftingIndicatorWrapper(IntPtr p)
        {
            API.Initialize(out _d);
            if( p != IntPtr.Zero )
            {
                API.A3DMDFCFDraftingIndicatorGet( p, ref _d );
            }
        }

        public void Dispose()
        {
            API.A3DMDFCFDraftingIndicatorGet( IntPtr.Zero, ref _d );
        }
        public ushort m_usStructSize=>_d.m_usStructSize;
        public EA3DFCFIndicatorType m_eType=>_d.m_eType;
        public uint m_uiNumberOfTexts=>_d.m_uiNumberOfTexts;
        public IntPtr m_ppcTexts=>_d.m_ppcTexts;

        private A3DMDFCFDraftingIndicatorData _d;
    }
    public class A3DMDFeatureControlFrameWrapper : IDisposable
    {
    ...
    public class A3DMDToleranceSizeValueWrapper : IDisposable
    {
    ...
    public class A3DMDToleranceSizeWrapper : IDisposable
    {
    ...
    public class A3DMarkupGDTWrapper : IDisposable
    {
    ...
    public class A3DMarkupSpotWeldingWrapper : IDisposable
    {
    ...
    public class A3DMarkupLineWeldingWrapper : IDisposable
    {
    ...
    public class A3DMathFct1DPolynomWrapper : IDisposable
    {
    ...
    public class A3DMathFct1DTrigonometricWrapper : IDisposable
    {
    ...
    public class A3DMathFct1DFractionWrapper : IDisposable
    {
    ...
    public class A3DMathFct1DArctanCosWrapper : IDisposable
    {
    ...
    public class A3DMathFct1DCombinationWrapper : IDisposable
    {
    ...
    public class A3DMathFct3DLinearWrapper : IDisposable
    {
    ...
    public class A3DMathFct3DNonLinearWrapper : IDisposable
    {
    ...
    public class A3DRootBaseWrapper : IDisposable
    {
    ...
    public class A3DRootBaseWithGraphicsWrapper : IDisposable
    {
    ...
    public class A3DMiscSingleAttributeWrapper : IDisposable
    {
        ...
        public IntPtr m_pcData => _d.m_pcData;
        public ushort m_usUnit=>_d.m_usUnit;

        private A3DMiscSingleAttributeData _d;
    }
    public class A3DMiscAttributeWrapper : IDisposable
    {
    ...
    public class A3DMiscAttributeBasicUnitWrapper : IDisposable
    {
    ...
    public class A3DMiscAttributeUnitWrapper : IDisposable
    {
    ...
    public class A3DCopyAndAdaptBrepModelWrapper : IDisposable
    {
    ...
    public class A3DPhysicalPropertiesWrapper : IDisposable
    {
    ...
    public class A3DTopoBodyWrapper : IDisposable
    {
    ...
    public class A3DTopoContextWrapper : IDisposable
    {
    ...
    public class A3DTopoSingleWireBodyWrapper : IDisposable
    {
    ...
    public class A3DTopoBrepDataWrapper : IDisposable
    {
    ...
    public class A3DTopoConnexWrapper : IDisposable
    {
    ...
    public class A3DTopoShellWrapper : IDisposable
    {
    ...
    public class A3DTopoFaceWrapper : IDisposable
    {
    ...
    public class A3DTopoLoopWrapper : IDisposable
    {
    ...
    public class A3DTopoCoEdgeWrapper : IDisposable
    {
    ...
    public class A3DTopoEdgeWrapper : IDisposable
    {
    ...
    public class A3DTopoWireEdgeWrapper : IDisposable
    {
    ...
    public class A3DTopoUniqueVertexWrapper : IDisposable
    {
    ...
    public class A3DTopoMultipleVertexWrapper : IDisposable
    {
