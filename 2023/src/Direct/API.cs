...
namespace TS3D.Exchange.Direct
{
    ...
    public static void Initialize(out A3DVector2dData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    ...
    public static void Initialize(out A3DDomainData d ) { 
        d = new A3DDomainData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sMin.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sMin);
        d.m_sMax.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sMax);
    }
    ...
    public static void Initialize(out A3DParameterizationData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sInterval.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sInterval);
    }
    public static void Initialize(out A3DUVParameterizationData d ) { 
        d = new A3DUVParameterizationData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sUVDomain.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sUVDomain);
        d.m_sUVDomain.m_sMin.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sUVDomain.m_sMin);
        d.m_sUVDomain.m_sMax.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sUVDomain.m_sMax);
    }
    ...
    public static void Initialize(out A3DGraphHatchingPatternLineData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sStart.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sStart);
        d.m_sOffset.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sOffset);
    }
    ...
    public static void Initialize(out A3DGraphCameraData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sLocation.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sLocation);
        d.m_sLookAt.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sLookAt);
        d.m_sUp.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sUp);
    }
    ...
    public static void Initialize(out A3DGraphSpotLightData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sDirection.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sDirection);
        d.m_sLocation.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sLocation);
    }
    ...
    public static void Initialize(out A3DGraphSceneDisplayParametersData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sRotationCenter.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sRotationCenter);
    }
    public static void Initialize(out A3DMiscCascadedAttributesData d ) { 
        d = new A3DMiscCascadedAttributesData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sStyle.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sStyle);
    }
    ...
    public static void Initialize(out A3DMiscCartesianTransformationData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sOrigin.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sOrigin);
        d.m_sXVector.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sXVector);
        d.m_sYVector.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sYVector);
        d.m_sScale.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sScale);
    }
    ...
    public static void Initialize(out A3DMiscMaterialPropertiesData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        // d.m_sOrthotropic3D.m_usStructSize = (UInt16)Marshal.SizeOf(// d.m_sOrthotropic3D);
    }
    ...
    public static void Initialize(out A3DAsmPartDefinitionData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sBoundingBox.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sBoundingBox);
        d.m_sBoundingBox.m_sMin.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sBoundingBox.m_sMin);
        d.m_sBoundingBox.m_sMax.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sBoundingBox.m_sMax);
    }
    ...
    public static void Initialize(out A3DAsmFilterData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sLayerFilterItem.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sLayerFilterItem);
        d.m_sEntityFilterItem.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sEntityFilterItem);
    }
    ...
    public static void Initialize(out A3DRWParamsStepData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sValidationPropertiesThreshold.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sValidationPropertiesThreshold);
        d.m_sValidationPropertiesThreshold.m_dGEOMPercentVolume = 0.5;
        d.m_sValidationPropertiesThreshold.m_dGEOMPercentSurfaceArea = 0.5;
        d.m_sValidationPropertiesThreshold.m_dGEOMPercentIndependentSurfaceArea = 0.5;
        d.m_sValidationPropertiesThreshold.m_dGEOMPercentIndependentCurveLength = 0.5;
        d.m_sValidationPropertiesThreshold.m_dGEOMDeviationCentroid = 0.1;
        d.m_sValidationPropertiesThreshold.m_dGEOMDeviationIndependentSurfaceCentroid = 0.1;
        d.m_sValidationPropertiesThreshold.m_dGEOMDeviationIndependentCurveCentroid = 0.1;
        d.m_sValidationPropertiesThreshold.m_dGEOMDeviationPointSetCentroid = 0.1;
        d.m_sValidationPropertiesThreshold.m_dGEOMDeviationBoundingBox = 0.1;
        d.m_sValidationPropertiesThreshold.m_dPMIPercentAffectedArea = 0.5;
        d.m_sValidationPropertiesThreshold.m_dPMIPercentAffectedCurveLength = 0.5;
        d.m_sValidationPropertiesThreshold.m_dPMIPercentCurveLength = 0.5;
        d.m_sValidationPropertiesThreshold.m_dPMIPercentSurfaceArea = 0.5;
        d.m_sValidationPropertiesThreshold.m_dPMIDeviationCurveCentroid = 0.1;
        d.m_sValidationPropertiesThreshold.m_dPMIDeviationSurfaceCentroid = 0.1;
        d.m_sValidationPropertiesThreshold.m_dASMDeviationNotionalSolidsCentroid = 0.1;
    ...
    public static void Initialize(out A3DRWParamsRevitData d ) { 
        ...
        d.m_eMultiThreadedMode = EA3DRevitMultiThreadedMode.kA3DRevitMultiThreadedMode_LoadingAndRegenerationEnabled;
        d.m_uiLinkFlags = (UInt32)EA3DRevitLinks.kA3DRevitLinks_LoadAll;
    }
    public static void Initialize(out A3DRWParamsSpecificLoadData d ) { 
        d = new A3DRWParamsSpecificLoadData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sCatiaV4.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sCatiaV4);
        d.m_sCatiaV5.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sCatiaV5);
        d.m_sUnigraphics.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sUnigraphics);
        d.m_sProE.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sProE);
        d.m_sProE.m_eFamilyTables = A3DProEFamilyTables.A3DProEFamTabOrUseTessellation;
        d.m_sProE.m_bBoolOpUseGenericIfNoTess = false;
        d.m_sProE.m_bFlexCompUseGenericIfNoTess = false;
        d.m_sProE.m_bHideSkeletons = false;
        d.m_sStep.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sStep);
        d.m_sStep.m_sValidationPropertiesThreshold.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sStep.m_sValidationPropertiesThreshold);
        d.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMPercentVolume = 0.5;
        d.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMPercentSurfaceArea = 0.5;
        d.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMPercentIndependentSurfaceArea = 0.5;
        d.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMPercentIndependentCurveLength = 0.5;
        d.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMDeviationCentroid = 0.1;
        d.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMDeviationIndependentSurfaceCentroid = 0.1;
        d.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMDeviationIndependentCurveCentroid = 0.1;
        d.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMDeviationPointSetCentroid = 0.1;
        d.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMDeviationBoundingBox = 0.1;
        d.m_sStep.m_sValidationPropertiesThreshold.m_dPMIPercentAffectedArea = 0.5;
        d.m_sStep.m_sValidationPropertiesThreshold.m_dPMIPercentAffectedCurveLength = 0.5;
        d.m_sStep.m_sValidationPropertiesThreshold.m_dPMIPercentCurveLength = 0.5;
        d.m_sStep.m_sValidationPropertiesThreshold.m_dPMIPercentSurfaceArea = 0.5;
        d.m_sStep.m_sValidationPropertiesThreshold.m_dPMIDeviationCurveCentroid = 0.1;
        d.m_sStep.m_sValidationPropertiesThreshold.m_dPMIDeviationSurfaceCentroid = 0.1;
        d.m_sStep.m_sValidationPropertiesThreshold.m_dASMDeviationNotionalSolidsCentroid = 0.1;
        d.m_sStep.m_eNameFromNAUO = A3DEStepNameFromNAUO.kA3DStepNameFromNAUO_DESCRIPTION;
        d.m_sStep.m_bSplitSHELL_BASED_SURFACE_MODEL = true;
        d.m_sStep.m_bHealOrientations = false;
        d.m_sIGES.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sIGES);
        d.m_sIFC.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sIFC);
        d.m_sIFC.m_bFACETED_BREPAsOneFace = true;
        d.m_sJT.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sJT);
        d.m_sJT.m_eReadTessellationLevelOfDetail = A3DEJTReadTessellationLevelOfDetail.kA3DJTTessLODHigh;
        d.m_sParasolid.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sParasolid);
        d.m_sSolidworks.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSolidworks);
        d.m_sSolidworks.m_bLoadAllConfigsData = false;
        d.m_sSolidworks.m_usDisplayVisibleDatum = 0;
        d.m_sInventor.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sInventor);
        d.m_sInventor.m_bUseTessForFile = true;
        d.m_sRhino.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sRhino);
        d.m_sRhino.m_bForceRenderedModeColors = false;
        d.m_sRevit.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sRevit);
        d.m_sRevit.m_ePhysicalProperties = EA3DRevitPhysicalProperties.kA3DRevitPhysicalProperties_NotComputed;
        d.m_sRevit.m_eMultiThreadedMode = EA3DRevitMultiThreadedMode.kA3DRevitMultiThreadedMode_LoadingAndRegenerationEnabled;
        d.m_sRevit.m_uiLinkFlags = (UInt32)EA3DRevitLinks.kA3DRevitLinks_LoadAll;
    }
    ...
    public static void Initialize(out A3DRWParamsLoadData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sGeneral.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sGeneral);
        d.m_sPmi.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sPmi);
        d.m_sTessellation.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sTessellation);
        d.m_sAssembly.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sAssembly);
        d.m_sMultiEntries.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sMultiEntries);
        d.m_sSpecifics.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSpecifics);
        d.m_sSpecifics.m_sCatiaV4.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSpecifics.m_sCatiaV4);
        d.m_sSpecifics.m_sCatiaV5.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSpecifics.m_sCatiaV5);
        d.m_sSpecifics.m_sUnigraphics.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSpecifics.m_sUnigraphics);
        d.m_sSpecifics.m_sProE.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSpecifics.m_sProE);
        d.m_sSpecifics.m_sProE.m_eFamilyTables = A3DProEFamilyTables.A3DProEFamTabOrUseTessellation;
        d.m_sSpecifics.m_sProE.m_bBoolOpUseGenericIfNoTess = false;
        d.m_sSpecifics.m_sProE.m_bFlexCompUseGenericIfNoTess = false;
        d.m_sSpecifics.m_sProE.m_bHideSkeletons = false;
        d.m_sSpecifics.m_sStep.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSpecifics.m_sStep);
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold);
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMPercentVolume = 0.5;
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMPercentSurfaceArea = 0.5;
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMPercentIndependentSurfaceArea = 0.5;
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMPercentIndependentCurveLength = 0.5;
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMDeviationCentroid = 0.1;
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMDeviationIndependentSurfaceCentroid = 0.1;
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMDeviationIndependentCurveCentroid = 0.1;
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMDeviationPointSetCentroid = 0.1;
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_dGEOMDeviationBoundingBox = 0.1;
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_dPMIPercentAffectedArea = 0.5;
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_dPMIPercentAffectedCurveLength = 0.5;
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_dPMIPercentCurveLength = 0.5;
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_dPMIPercentSurfaceArea = 0.5;
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_dPMIDeviationCurveCentroid = 0.1;
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_dPMIDeviationSurfaceCentroid = 0.1;
        d.m_sSpecifics.m_sStep.m_sValidationPropertiesThreshold.m_dASMDeviationNotionalSolidsCentroid = 0.1;
        d.m_sSpecifics.m_sStep.m_eNameFromNAUO = A3DEStepNameFromNAUO.kA3DStepNameFromNAUO_DESCRIPTION;
        d.m_sSpecifics.m_sStep.m_bSplitSHELL_BASED_SURFACE_MODEL = true;
        d.m_sSpecifics.m_sStep.m_bHealOrientations = false;
        d.m_sSpecifics.m_sIGES.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSpecifics.m_sIGES);
        d.m_sSpecifics.m_sIFC.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSpecifics.m_sIFC);
        d.m_sSpecifics.m_sIFC.m_bFACETED_BREPAsOneFace = true;
        d.m_sSpecifics.m_sJT.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSpecifics.m_sJT);
        d.m_sSpecifics.m_sJT.m_eReadTessellationLevelOfDetail = A3DEJTReadTessellationLevelOfDetail.kA3DJTTessLODHigh;
        d.m_sSpecifics.m_sParasolid.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSpecifics.m_sParasolid);
        d.m_sSpecifics.m_sSolidworks.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSpecifics.m_sSolidworks);
        d.m_sSpecifics.m_sSolidworks.m_bLoadAllConfigsData = false;
        d.m_sSpecifics.m_sSolidworks.m_usDisplayVisibleDatum = 0;
        d.m_sSpecifics.m_sInventor.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSpecifics.m_sInventor);
        d.m_sSpecifics.m_sInventor.m_bUseTessForFile = true;
        d.m_sSpecifics.m_sRhino.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSpecifics.m_sRhino);
        d.m_sSpecifics.m_sRhino.m_bForceRenderedModeColors = false;
        d.m_sSpecifics.m_sRevit.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSpecifics.m_sRevit);
        d.m_sSpecifics.m_sRevit.m_ePhysicalProperties = EA3DRevitPhysicalProperties.kA3DRevitPhysicalProperties_NotComputed;
        d.m_sSpecifics.m_sRevit.m_eMultiThreadedMode = EA3DRevitMultiThreadedMode.kA3DRevitMultiThreadedMode_LoadingAndRegenerationEnabled;
        d.m_sSpecifics.m_sRevit.m_uiLinkFlags = (UInt32)EA3DRevitLinks.kA3DRevitLinks_LoadAll;
        d.m_sIncremental.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sIncremental);
    }
    ...
    public static void Initialize(out A3DRWParamsExport3mfData d ) { 
        ...
        d.m_sTessellation.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sTessellation);
        d.m_sTessellation.m_eTessellationLevelOfDetail = A3DETessellationLevelOfDetail.kA3DTessLODMedium;
    }
    ...
    public static void Initialize(out A3DRWParamsExportGltfData d ) { 
        d = new A3DRWParamsExportGltfData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    ...
    public static void Initialize(out A3DProjectedPointCloudData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sPt.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sPt);
        d.m_sUV.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sUV);
    }
    public static void Initialize(out A3DProjectPointCloudManagerDataFromRI d ) { 
        d = new A3DProjectPointCloudManagerDataFromRI();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    public static void Initialize(out A3DProjectPointCloudOptionsData d ) { 
        d = new A3DProjectPointCloudOptionsData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    ...
    public static void Initialize(out A3DMultiPlanarSectionData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sExtrudeDirection.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sExtrudeDirection);
        d.m_sProfileNormal.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sProfileNormal);
    }
    ...
    public static void Initialize(out A3DBIMDataData d ) { 
        d = new A3DBIMDataData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    public static void Initialize(out A3DBIMRelContainedInSpatialStructureData d ) { 
        d = new A3DBIMRelContainedInSpatialStructureData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    public static void Initialize(out A3DBIMRelFillsElementData d ) { 
        d = new A3DBIMRelFillsElementData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    public static void Initialize(out A3DBIMRelSpaceBoundaryData d ) { 
        d = new A3DBIMRelSpaceBoundaryData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    public static void Initialize(out A3DBIMRelAggregatesData d ) { 
        d = new A3DBIMRelAggregatesData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    public static void Initialize(out A3DBIMRelVoidsElementData d ) { 
        d = new A3DBIMRelVoidsElementData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    public static void Initialize(out A3DBIMRelConnectsPathElementsData d ) { 
        d = new A3DBIMRelConnectsPathElementsData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    public static void Initialize(out A3DBIMRootData d ) { 
        d = new A3DBIMRootData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    public static void Initialize(out A3DMiscConstraintLinkedItemData d ) { 
        d = new A3DMiscConstraintLinkedItemData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    public static void Initialize(out A3DAsmConstraintData d ) { 
        d = new A3DAsmConstraintData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    ...
    public static void Initialize(out A3DDrawingSheetFormatData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sSize.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSize);
    }
    public static void Initialize(out A3DDrawingSheetData d ) { 
        d = new A3DDrawingSheetData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sSize.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSize);
        d.m_sRefPoint.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sRefPoint);
    }
    public static void Initialize(out A3DDrawingClipFrameData d ) { 
        d = new A3DDrawingClipFrameData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sRectangularBox.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sRectangularBox);
        d.m_sRectangularBox.m_sMin.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sRectangularBox.m_sMin);
        d.m_sRectangularBox.m_sMax.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sRectangularBox.m_sMax);
    }
    public static void Initialize(out A3DDrawingViewData d ) { 
        d = new A3DDrawingViewData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sOriginOnSheet.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sOriginOnSheet);
        d.m_sOffsetLocation.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sOffsetLocation);
    }
    ...
    public static void Initialize(out A3DDrawingCurveData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sTrimInterval.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sTrimInterval);
    }
    ...
    public static void Initialize(out A3DDrawingPictureData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sPosition.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sPosition);
        d.m_sSize.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSize);
    }
    ...
    public static void Initialize(out A3DFRMTreeData d ) { 
        d = new A3DFRMTreeData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    ...
    public static void Initialize(out A3DFRMTypeData d ) { 
        d = new A3DFRMTypeData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    ...
    public static void Initialize(out A3DFRMLinkedItemData d ) { 
        d = new A3DFRMLinkedItemData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    public static void Initialize(out A3DFRMFeatureData d ) { 
        d = new A3DFRMFeatureData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sType.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sType);
    }
    public static void Initialize(out A3DFRMGeomEntitiesData d ) { 
        d = new A3DFRMGeomEntitiesData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    ...
    public static void Initialize(out A3DCrvLineData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sTrsf.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sTrsf);
        d.m_sTrsf.m_sOrigin.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sTrsf.m_sOrigin);
        d.m_sTrsf.m_sXVector.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sTrsf.m_sXVector);
        d.m_sTrsf.m_sYVector.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sTrsf.m_sYVector);
        d.m_sTrsf.m_sScale.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sTrsf.m_sScale);
        d.m_sParam.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sParam);
        d.m_sParam.m_sInterval.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sParam.m_sInterval);
    }
    ...
    public static void Initialize(out A3DCrvEquationData d ) { 
        ...
        d.m_sParam.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sParam);
        d.m_sParam.m_sInterval.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sParam.m_sInterval);
        d.m_sMaxInterval.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sMaxInterval);
    }
    ...
    public static void Initialize(out A3DCrvOffsetData d ) { 
        ...
        d.m_sParam.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sParam);
        d.m_sParam.m_sInterval.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sParam.m_sInterval);
        d.m_sVector.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sVector);
    }
    public static void Initialize(out A3DCrvHelixPitchCstData d ) { 
        d = new A3DCrvHelixPitchCstData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sStartPoint.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sStartPoint);
        d.m_sOrigin.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sOrigin);
        d.m_sDirection.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sDirection);
    }
    public static void Initialize(out A3DCrvHelixPitchVarData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sStartPoint.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sStartPoint);
        d.m_sUnitZ.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sUnitZ);
        d.m_sUnitU.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sUnitU);
    }
    public static void Initialize(out A3DCrvHelixData d ) { 
        ...
        d.m_sParam.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sParam);
        d.m_sParam.m_sInterval.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sParam.m_sInterval);
        d.m_sCstHelixData.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sCstHelixData);
        d.m_sCstHelixData.m_sStartPoint.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sCstHelixData.m_sStartPoint);
        d.m_sCstHelixData.m_sOrigin.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sCstHelixData.m_sOrigin);
        d.m_sCstHelixData.m_sDirection.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sCstHelixData.m_sDirection);
        d.m_sVarHelixData.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sVarHelixData);
        d.m_sVarHelixData.m_sStartPoint.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sVarHelixData.m_sStartPoint);
        d.m_sVarHelixData.m_sUnitZ.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sVarHelixData.m_sUnitZ);
        d.m_sVarHelixData.m_sUnitU.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sVarHelixData.m_sUnitU);
    }
    public static void Initialize(out A3DCrossingPointsCrvIntersectionData d ) { 
        d = new A3DCrossingPointsCrvIntersectionData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sPosition.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sPosition);
        d.m_sUVPosition1.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sUVPosition1);
        d.m_sUVPosition2.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sUVPosition2);
        d.m_sTangent.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sTangent);
    }
    public static void Initialize(out A3DCrvIntersectionData d ) { 
        ...
        d.m_sParam.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sParam);
        d.m_sParam.m_sInterval.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sParam.m_sInterval);
        d.m_sStartLimitPoint.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sStartLimitPoint);
        d.m_sEndLimitPoint.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sEndLimitPoint);
    }
    ...
    public static void Initialize(out A3DSurfSphereData d ) { 
        ...
        d.m_sTrsf.m_sScale.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sTrsf.m_sScale);
        d.m_sParam.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sParam);
        d.m_sParam.m_sUVDomain.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sParam.m_sUVDomain);
        d.m_sParam.m_sUVDomain.m_sMin.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sParam.m_sUVDomain.m_sMin);
        d.m_sParam.m_sUVDomain.m_sMax.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sParam.m_sUVDomain.m_sMax);
    }
    ...
    public static void Initialize(out A3DMDPositionReferenceData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sOffsetToReference.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sOffsetToReference);
    }
    ...
    public static void Initialize(out A3DMDDimensionExtentionLineData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sExtremity1.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sExtremity1);
        d.m_sExtremity2.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sExtremity2);
    }
    ...
    public static void Initialize(out A3DMarkupFastenerData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sAxisVector.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sAxisVector);
        d.m_sIndexVector.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sIndexVector);
        d.m_sOptionalVector.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sOptionalVector);
    }
    public static void Initialize(out A3DMarkupLocatorData d ) { 
        d = new A3DMarkupLocatorData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sHotSpot.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sHotSpot);
        d.m_sPunchDirection.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sPunchDirection);
        d.m_sPinDirection.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sPinDirection);
        d.m_sNormalDirection.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sNormalDirection);
    }
    public static void Initialize(out A3DMarkupMeasurementPointData d ) { 
        d = new A3DMarkupMeasurementPointData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sLocation.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sLocation);
        d.m_sMeasurementVector.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sMeasurementVector);
        d.m_sCoordinationVector.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sCoordinationVector);
        d.m_sNormalVector.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sNormalVector);
    }
    public static void Initialize(out A3DMDTextPositionData d ) { 
        d = new A3DMDTextPositionData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sPosition.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sPosition);
        d.m_sBaseVector.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sBaseVector);
        d.m_sUpVector.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sUpVector);
    }
    ...
    public static void Initialize(out A3DMDFCProjectedZoneData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sLength.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sLength);
    }
    public static void Initialize(out A3DMDFCFToleranceValueData d ) { 
        d = new A3DMDFCFToleranceValueData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sValue.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sValue);
    }
    ...
    public static void Initialize(out A3DMDFCFDraftingIndicatorData d ) { 
        d = new A3DMDFCFDraftingIndicatorData();
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
    }
    ...
    public static void Initialize(out A3DMDToleranceSizeValueData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sMainValue.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sMainValue);
    }
    ...
    public static void Initialize(out A3DMarkupSpotWeldingData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sApproachVector.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sApproachVector);
        d.m_sClampingVector.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sClampingVector);
        d.m_sNormalVector.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sNormalVector);
    }
    ...
    public static void Initialize(out A3DPhysicalPropertiesData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sGravityCenter.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sGravityCenter);
        d.m_sSurfacicGravityCenter.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSurfacicGravityCenter);
    ...
    public static void Initialize(out A3DTopoFaceData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sSurfaceDomain.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSurfaceDomain);
        d.m_sSurfaceDomain.m_sMin.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSurfaceDomain.m_sMin);
        d.m_sSurfaceDomain.m_sMax.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sSurfaceDomain.m_sMax);
    }
    ...
    public static void Initialize(out A3DTopoUniqueVertexData d ) { 
        ...
        d.m_usStructSize = (UInt16)Marshal.SizeOf(d);
        d.m_sPoint.m_usStructSize = (UInt16)Marshal.SizeOf(d.m_sPoint);
    }
    public static void Initialize(out A3DTopoMultipleVertexData d ) { 
        ...
        public delegate A3DEUnits PFA3DUnitGetFromValue(double dUnit);
        public static PFA3DUnitGetFromValue A3DUnitGetFromValue = null;
        public delegate double PFA3DUnitGetFromEnum(A3DEUnits eUnit);
        public static PFA3DUnitGetFromEnum A3DUnitGetFromEnum = null;
        ...
        public delegate A3DStatus PFA3DAsmModelFileExportToGltfFile(IntPtr pA3DAsmModelFile, ref A3DRWParamsExportGltfData pParamsExportData, [MarshalAs(UnmanagedType.LPStr)] string pcCADFileName);
        public static PFA3DAsmModelFileExportToGltfFile A3DAsmModelFileExportToGltfFile = null;
        ...
        public delegate A3DStatus PFA3DSurfGetDomain(IntPtr pSrf, ref A3DDomainData pDomain);
        public static PFA3DSurfGetDomain A3DSurfGetDomain = null;
        ...
        public delegate A3DStatus PFA3DProjectPointCloud3(IntPtr pManager, uint uPointCloudSize, ref A3DVector3dData pPointCloudToProject, ref A3DProjectPointCloudOptionsData pOptions, IntPtr ppProjectedPointCloud);
        public static PFA3DProjectPointCloud3 A3DProjectPointCloud3 = null;
        ...
        public delegate A3DStatus PFA3DDllGetBuildInformation(IntPtr ppBuildInformation);
        public static PFA3DDllGetBuildInformation A3DDllGetBuildInformation = null;
        public delegate IntPtr A3DCallbackMemoryAlloc(ulong arg1);
        ...
        public delegate A3DStatus PFA3DBIMDataGet(IntPtr pDBIMData, ref A3DBIMDataData pData);
        public static PFA3DBIMDataGet A3DBIMDataGet = null;
        public delegate A3DStatus PFA3DBIMRelContainedInSpatialStructureGet(IntPtr pRelationship, ref A3DBIMRelContainedInSpatialStructureData pData);
        public static PFA3DBIMRelContainedInSpatialStructureGet A3DBIMRelContainedInSpatialStructureGet = null;
        public delegate A3DStatus PFA3DBIMRelFillsElementGet(IntPtr pRelationship, ref A3DBIMRelFillsElementData pData);
        public static PFA3DBIMRelFillsElementGet A3DBIMRelFillsElementGet = null;
        public delegate A3DStatus PFA3DBIMRelSpaceBoundaryGet(IntPtr pRelationship, ref A3DBIMRelSpaceBoundaryData pData);
        public static PFA3DBIMRelSpaceBoundaryGet A3DBIMRelSpaceBoundaryGet = null;
        public delegate A3DStatus PFA3DBIMRelAggregatesGet(IntPtr pRelationship, ref A3DBIMRelAggregatesData pData);
        public static PFA3DBIMRelAggregatesGet A3DBIMRelAggregatesGet = null;
        public delegate A3DStatus PFA3DBIMRelVoidsElementGet(IntPtr pRelationship, ref A3DBIMRelVoidsElementData pData);
        public static PFA3DBIMRelVoidsElementGet A3DBIMRelVoidsElementGet = null;
        public delegate A3DStatus PFA3DBIMRelConnectsPathElementsGet(IntPtr pRelationship, ref A3DBIMRelConnectsPathElementsData pData);
        public static PFA3DBIMRelConnectsPathElementsGet A3DBIMRelConnectsPathElementsGet = null;
        public delegate A3DStatus PFA3DBIMRootGet(IntPtr pRoot, ref A3DBIMRootData pData);
        public static PFA3DBIMRootGet A3DBIMRootGet = null;
        public delegate A3DStatus PFA3DAsmModelFileExportToIfcXMLFile(IntPtr pA3DAsmModelFile, [MarshalAs(UnmanagedType.LPStr)] string pcXMLFileName);
        public static PFA3DAsmModelFileExportToIfcXMLFile A3DAsmModelFileExportToIfcXMLFile = null;
        public delegate A3DStatus PFA3DMiscConstraintLinkedItemGet(IntPtr pLinkedItem, ref A3DMiscConstraintLinkedItemData pData);
        public static PFA3DMiscConstraintLinkedItemGet A3DMiscConstraintLinkedItemGet = null;
        public delegate A3DStatus PFA3DAsmConstraintGet(IntPtr pConstraint, ref A3DAsmConstraintData pData);
        public static PFA3DAsmConstraintGet A3DAsmConstraintGet = null;
        ...
        public delegate A3DStatus PFA3DFRMTreeGet(IntPtr pTree, ref A3DFRMTreeData pData);
        public static PFA3DFRMTreeGet A3DFRMTreeGet = null;
        ...
        public delegate A3DStatus PFA3DFRMLinkedItemGet(IntPtr p, ref A3DFRMLinkedItemData pData);
        public static PFA3DFRMLinkedItemGet A3DFRMLinkedItemGet = null;
        ...
        public delegate A3DStatus PFA3DFRMGeomEntitiesExtract(IntPtr pFeature, ref A3DFRMGeomEntitiesData pFeatureGeomEntities);
        public static PFA3DFRMGeomEntitiesExtract A3DFRMGeomEntitiesExtract = null;
        ...
        public delegate A3DStatus PFA3DSurfBaseWithDomainGetAsNurbs(IntPtr pSrf, ref A3DDomainData pOptDomain, double dTolerance, bool bUseSameParameterization, ref A3DSurfNurbsData pData);
        public static PFA3DSurfBaseWithDomainGetAsNurbs A3DSurfBaseWithDomainGetAsNurbs = null;
        ...
        public delegate A3DStatus PFA3DMDFCFDraftingIndicatorGet(IntPtr pIndicator, ref A3DMDFCFDraftingIndicatorData pData);
        public static PFA3DMDFCFDraftingIndicatorGet A3DMDFCFDraftingIndicatorGet = null;
        ...
        public delegate A3DStatus PFA3DMkpMarkupSet(IntPtr pMarkup, ref A3DMkpMarkupData pData);
        public static PFA3DMkpMarkupSet A3DMkpMarkupSet = null;
        public delegate A3DStatus PFA3DMDLeaderDefinitionSet(IntPtr pLeader, ref A3DMDLeaderDefinitionData pData);
        public static PFA3DMDLeaderDefinitionSet A3DMDLeaderDefinitionSet = null;
        public delegate A3DStatus PFA3DMarkupDefinitionSet(ref A3DMarkupDefinitionData pData, IntPtr pMarkupDefinition);
        public static PFA3DMarkupDefinitionSet A3DMarkupDefinitionSet = null;
        public delegate A3DStatus PFA3DMarkupTextSet(ref A3DMarkupTextData pData, IntPtr pMarkupText);
        public static PFA3DMarkupTextSet A3DMarkupTextSet = null;
        public delegate A3DStatus PFA3DMarkupTextCreate(ref A3DMarkupTextData pData, out IntPtr ppMarkupText);
        public static PFA3DMarkupTextCreate A3DMarkupTextCreate = null;
        public delegate A3DStatus PFA3DMarkupCoordinateCreate(ref A3DMarkupCoordinateData pData, out IntPtr ppMarkupCoordinate);
        public static PFA3DMarkupCoordinateCreate A3DMarkupCoordinateCreate = null;
        public delegate A3DStatus PFA3DMarkupRichTextCreate(ref A3DMarkupRichTextData pData, out IntPtr ppMarkupRichText);
        public static PFA3DMarkupRichTextCreate A3DMarkupRichTextCreate = null;
        public delegate A3DStatus PFA3DMarkupRoughnessCreate(ref A3DMarkupRoughnessData pData, out IntPtr ppMarkupRoughness);
        public static PFA3DMarkupRoughnessCreate A3DMarkupRoughnessCreate = null;
        public delegate A3DStatus PFA3DMarkupBalloonCreate(ref A3DMarkupBalloonData pData, out IntPtr ppBalloon);
        public static PFA3DMarkupBalloonCreate A3DMarkupBalloonCreate = null;
        public delegate A3DStatus PFA3DMarkupFastenerCreate(ref A3DMarkupFastenerData pData, out IntPtr ppFastener);
        public static PFA3DMarkupFastenerCreate A3DMarkupFastenerCreate = null;
        public delegate A3DStatus PFA3DMarkupLocatorCreate(ref A3DMarkupLocatorData pData, out IntPtr ppLocator);
        public static PFA3DMarkupLocatorCreate A3DMarkupLocatorCreate = null;
        public delegate A3DStatus PFA3DMarkupMeasurementPointCreate(ref A3DMarkupMeasurementPointData pData, out IntPtr ppMeasurementPoint);
        public static PFA3DMarkupMeasurementPointCreate A3DMarkupMeasurementPointCreate = null;
        public delegate A3DStatus PFA3DMarkupDatumCreate(ref A3DMarkupDatumData pData, out IntPtr ppMarkupDatum);
        public static PFA3DMarkupDatumCreate A3DMarkupDatumCreate = null;
        public delegate A3DStatus PFA3DMkpDatumTargetSetDatumOwner(IntPtr pMarkupDatumTarget, IntPtr pMarkupDatumOwner);
        public static PFA3DMkpDatumTargetSetDatumOwner A3DMkpDatumTargetSetDatumOwner = null;
        public delegate A3DStatus PFA3DMkpAddMarkupLinkedItemTag(IntPtr pMarkupLinkedItem, bool bMainReference);
        public static PFA3DMkpAddMarkupLinkedItemTag A3DMkpAddMarkupLinkedItemTag = null;
        public delegate A3DStatus PFA3DMDFCFRowDatumCreate(ref A3DMDFCFRowDatumData pData, out IntPtr ppRowDatum);
        public static PFA3DMDFCFRowDatumCreate A3DMDFCFRowDatumCreate = null;
        public delegate A3DStatus PFA3DMDFCFDrawingRowCreate(ref A3DMDFCFDrawingRowData pData, out IntPtr ppDrawingRow);
        public static PFA3DMDFCFDrawingRowCreate A3DMDFCFDrawingRowCreate = null;
        public delegate A3DStatus PFA3DMDFeatureControlFrameCreate(ref A3DMDFeatureControlFrameData pData, out IntPtr ppFCF);
        public static PFA3DMDFeatureControlFrameCreate A3DMDFeatureControlFrameCreate = null;
        public delegate A3DStatus PFA3DMarkupGDTCreate(ref A3DMarkupGDTData pData, out IntPtr ppMarkupGDT);
        public static PFA3DMarkupGDTCreate A3DMarkupGDTCreate = null;
        public delegate A3DStatus PFA3DMDFCValueCreate(ref A3DMDFCValueData pData, out IntPtr ppValue);
        public static PFA3DMDFCValueCreate A3DMDFCValueCreate = null;
        public delegate A3DStatus PFA3DMDFCTolerancePerUnitCreate(ref A3DMDFCTolerancePerUnitData pData, out IntPtr ppTolerancePerUnit);
        public static PFA3DMDFCTolerancePerUnitCreate A3DMDFCTolerancePerUnitCreate = null;
        public delegate A3DStatus PFA3DMDFCProjectedZoneCreate(ref A3DMDFCProjectedZoneData pData, out IntPtr ppProjectedZone);
        public static PFA3DMDFCProjectedZoneCreate A3DMDFCProjectedZoneCreate = null;
        public delegate A3DStatus PFA3DMDFCFToleranceValueCreate(ref A3DMDFCFToleranceValueData pData, out IntPtr ppToleranceValue);
        public static PFA3DMDFCFToleranceValueCreate A3DMDFCFToleranceValueCreate = null;
        public delegate A3DStatus PFA3DMDDimensionSimpleToleranceFormatCreate(ref A3DMDDimensionSimpleToleranceFormatData pData, out IntPtr pDimensionToleranceFormat);
        public static PFA3DMDDimensionSimpleToleranceFormatCreate A3DMDDimensionSimpleToleranceFormatCreate = null;
        public delegate A3DStatus PFA3DMDDimensionCombinedToleranceFormatCreate(ref A3DMDDimensionCombinedToleranceFormatData pData, out IntPtr pDimensionToleranceFormat);
        public static PFA3DMDDimensionCombinedToleranceFormatCreate A3DMDDimensionCombinedToleranceFormatCreate = null;
        public delegate A3DStatus PFA3DMDDimensionValueCreate(ref A3DMDDimensionValueData pData, out IntPtr pDimensionValue);
        public static PFA3DMDDimensionValueCreate A3DMDDimensionValueCreate = null;
        public delegate A3DStatus PFA3DMDDimensionValueFormatCreate(ref A3DMDDimensionValueFormatData pData, out IntPtr ppDimensionValueFormat);
        public static PFA3DMDDimensionValueFormatCreate A3DMDDimensionValueFormatCreate = null;
        public delegate A3DStatus PFA3DMarkupDimensionCreate(ref A3DMarkupDimensionData pData, out IntPtr ppDimension);
        public static PFA3DMarkupDimensionCreate A3DMarkupDimensionCreate = null;
