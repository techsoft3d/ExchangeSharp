...
namespace TS3D.Exchange.Direct
{
    ...
    public unsafe struct A3DAsmProductOccurrenceData
    {
        ...
        public uint m_uiContraintsSize;
        public IntPtr m_ppConstraints;
    }
    ...
    public unsafe struct A3DRWParamsGeneralData
    {
        ...
        [MarshalAs(UnmanagedType.I1)] public bool m_bReadConstraints;
    ...
    public unsafe struct A3DRWParamsIFCData
    {
        ...
        [MarshalAs(UnmanagedType.I1)] public bool m_bReadRelationships;
        [MarshalAs(UnmanagedType.I1)] public bool m_bReadOpeningElements;
    }
    ...
    public unsafe struct A3DRWParamsRevitData
    {
        ...
        public EA3DRevitMultiThreadedMode m_eMultiThreadedMode;
        public uint m_uiLinkFlags;
    }
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DRWParamsExportGltfData
    {
        public ushort m_usStructSize;
        [MarshalAs(UnmanagedType.I1)] public bool m_bAscii;
        [MarshalAs(UnmanagedType.LPStr)] public string m_pcTextureFolder;
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DProjectPointCloudOptionsData
    {
        public ushort m_usStructSize;
        [MarshalAs(UnmanagedType.I1)] public bool m_bUseExactComputation;
        public uint m_uNbThreads;
        public double m_dInsidePointEdgeTolerance;
        [MarshalAs(UnmanagedType.I1)] public bool m_bUseProbe;
        public double m_dProbeRadius;
        [MarshalAs(UnmanagedType.I1)] public bool m_bPreferFaceTowardScan;
        public double m_dTolForPreferFaceTowardScan;
    }
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DBIMDataData
    {
        public ushort m_usStructSize;
        public uint m_uiRelationshipSize;
        public IntPtr m_ppRelationships;
        public IntPtr m_PProject;
    }

    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DBIMRelContainedInSpatialStructureData
    {
        public ushort m_usStructSize;
        public uint m_uiRelatedElementSize;
        public IntPtr m_ppRelatedElements;
        public IntPtr m_pRelating;
    }

    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DBIMRelFillsElementData
    {
        public ushort m_usStructSize;
        public uint m_uiRelatedElementSize;
        public IntPtr m_ppRelatedElements;
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DBIMRelSpaceBoundaryData
    {
        public ushort m_usStructSize;
        public uint m_uiRelatedElementSize;
        public IntPtr m_ppRelatedElements;
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DBIMRelAggregatesData
    {
        public ushort m_usStructSize;
        public uint m_uiRelatedElementSize;
        public IntPtr m_ppRelatedElements;
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DBIMRelVoidsElementData
    {
        public ushort m_usStructSize;
        public uint m_uiRelatedElementSize;
        public IntPtr m_ppRelatedElements;
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DBIMRelConnectsPathElementsData
    {
        public ushort m_usStructSize;
        public IntPtr m_pRelating;
        public uint m_uiRelatedElementSize;
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DBIMRootData
    {
        public ushort m_usStructSize;
        [MarshalAs(UnmanagedType.LPStr)] public string m_pcGUID;
        [MarshalAs(UnmanagedType.LPStr)] public string m_pcName;
        [MarshalAs(UnmanagedType.LPStr)] public string m_pcDescription;
        [MarshalAs(UnmanagedType.LPStr)] public string m_pcIfcClassName;
        public IntPtr m_pEntityReference;
    }

    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DMiscConstraintLinkedItemData
    {
        public ushort m_usStructSize;
        public EA3DConstraintLinkType m_eType;
        public IntPtr m_pTargetProductOccurrence;
        public IntPtr m_pReference;
    }

    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DAsmConstraintData
    {
        public ushort m_usStructSize;
        public EA3DConstraintType m_eType;
        public EA3DConstraintStatus m_eStatus;
        public uint m_uiSubConstraintsSize;
        public IntPtr m_ppSubConstraints;
        public uint m_uiConstrainedElementsSize;
        public IntPtr m_ppConstrainedElements;
        public uint m_uiAdditionalDataArraySize;
        public IntPtr m_pAdditionalDataArray;
    }
    ...
    public unsafe struct A3DRWParamsExportParasolidData
    {
        ...
        [MarshalAs(UnmanagedType.I1)] public bool m_bBinary;
    }
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DFRMTreeData
    {
        public ushort m_usStructSize;
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DFRMTypeData
    {
        public ushort m_usStructSize;
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DFRMLinkedItemData
    {
        public ushort m_usStructSize;
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DFRMGeomEntitiesData
    {
        public ushort m_usStructSize;
    ...
    public unsafe struct A3DMarkupTextData
    {
        ...
        public EA3DLeaderAlignmentType m_eLeaderAlignmentType;
        public IntPtr m_pTextProperties;
        public IntPtr m_psTextPosition;
    }
    ...
    public unsafe struct A3DMDFCFIndicatorData
    {
        ...
        [MarshalAs(UnmanagedType.LPStr)] public string m_pcText;
        public uint m_uiNumberOfLinkedItems;
        public IntPtr m_ppLinkedItems;
    }

    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public unsafe struct A3DMDFCFDraftingIndicatorData
    {
        public ushort m_usStructSize;
        public EA3DFCFIndicatorType m_eType;
        public uint m_uiNumberOfTexts;
        public IntPtr m_ppcTexts;
    }
