namespace TS3D.Exchange.Direct
{
    public class Constants
    {
        ...
        public static int A3D_DLL_MAJORVERSION = 13;
        public static int A3D_DLL_MINORVERSION = 2;
        ...
        public static int kA3DMarkupExtraDataType = 0x3E00000;
        public static int kA3DMarkupFaceViewMask = 0xC00000;
        public static int kA3DMarkupFixedSizeMask = 0x1000000;
        public static int kA3DMarkupFontMask = 0x1A00000;
        public static int kA3DMarkupFrameDrawMask = 0xE00000;
        public static int kA3DMarkupHasFrame = 0x02;
        public static int kA3DMarkupIntegerMask = 0xFFFFF;
        ...
        public static int kA3DMarkupPatternMask = 0x000000;
        public static int kA3DMarkupPictureMask = 0x200000;
        public static int kA3DMarkupPointsMask = 0x1E00000;
        public static int kA3DMarkupPolygonMask = 0x2000000;
        public static int kA3DMarkupQuadsMask = 0x600000;
        public static int kA3DMarkupSymbolMask = 0x1200000;
        public static int kA3DMarkupTextMask = 0x1C00000;
        public static int kA3DMarkupTrianglesMask = 0x400000;
        ...
        public static int kA3DTextureMappingMetallness = 0x0400;
        public static int kA3DTextureMappingMetallnessRoughness = kA3DTextureMappingMetalness | kA3DTextureMappingRoughness;
        public static int kA3DTextureMappingMetallnessRoughnessOcclusion = kA3DTextureMappingMetalnessRoughness | kA3DTextureMappingOcclusion;
